...
class MesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mesa" do
    assert_difference('Mesa.count') do
      post mesas_url, params: { mesa: { numero: @mesa.numero, restaurante_id: @mesa.restaurante_id } }
    end
  ...
  test "should update mesa" do
    patch mesa_url(@mesa), params: { mesa: { numero: @mesa.numero, restaurante_id: @mesa.restaurante_id } }
