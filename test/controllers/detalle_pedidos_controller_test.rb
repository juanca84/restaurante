...
class DetallePedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detalle_pedido" do
    assert_difference('DetallePedido.count') do
      post detalle_pedidos_url, params: { detalle_pedido: { menu: @detalle_pedido.menu, pedido_id: @detalle_pedido.pedido_id } }
    end
  ...
  test "should update detalle_pedido" do
    patch detalle_pedido_url(@detalle_pedido), params: { detalle_pedido: { menu: @detalle_pedido.menu, pedido_id: @detalle_pedido.pedido_id } }
