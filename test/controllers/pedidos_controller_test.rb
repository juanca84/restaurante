...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { cliente: @pedido.cliente, mesa_id: @pedido.mesa_id, numero: @pedido.numero, total: @pedido.total } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { cliente: @pedido.cliente, mesa_id: @pedido.mesa_id, numero: @pedido.numero, total: @pedido.total } }
