...
class RestaurantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create restaurante" do
    assert_difference('Restaurante.count') do
      post restaurantes_url, params: { restaurante: { nit: @restaurante.nit, nombre: @restaurante.nombre } }
    end
  ...
  test "should update restaurante" do
    patch restaurante_url(@restaurante), params: { restaurante: { nit: @restaurante.nit, nombre: @restaurante.nombre } }
